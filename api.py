#Tento kód vytvoří jednoduché API s jedním endpointem "/validate".
#Přijímá dva parametry "username" a "password" jako GET parametry a volá funkci "_validate_password()" pro ověření platnosti hesla. 
#Odpověď API obsahuje pole "is_valid", které udává, zda bylo heslo úspěšně ověřeno.
#Tímto úkolem splňuji tedy zadání do WAP, vykřičník ze sítí si tedy mažu.
